 ...
 */
public class ScanRecordAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    public ScanRecordAdapter(Context context, List<Shop> list) {
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.adapter_scan_record, null);
        }
